...
public class RecipeSummaryTabFragment extends Fragment {
    ...
    private void initializeSeeMoreButton() {
        binding.buttonSeeMore.setOnClickListener(view -> showSideRecipeDetails());
    }

    private void showSideRecipeDetails() {
        viewModel.showSideRecipeDetails(recipeUiModel);
    }
